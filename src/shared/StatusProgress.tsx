      ...
      {steps.map((step, index) => (
        <div
          ...
          className={`relative flex-1 ${
            index === steps.length - 1 ? "flex items-end justify-end" : ""
          }`}
        >
          {index < steps.length && (
            <div
          ...
          <div
            className={` w-fit px-2  rounded-md  text-center absolute top-[-6px] h-[21px] ${
              index <= currentStep
...
//   return (
//     <div className="flex justify-between mt-2">topbar
//       {steps.map((step, index) => (
//         <div
//           key={index}
//           className={`relative flex-1 ${
